...
export const de: Record<string, string> = {
  ...
  "crawl.confirm.recrawl.message": "Diese Quelle wurde bereits gecrawlt und indexiert. Unveränderte Seiten werden übersprungen. Nur neue oder aktualisierte Seiten werden gespeichert und indexiert.",
  "crawl.confirm.recrawl.messageWithModel": "Diese Quelle wurde bereits mit {{model}} gecrawlt und indexiert. Unveränderte Seiten werden übersprungen. Nur neue oder aktualisierte Seiten werden gespeichert und indexiert.",
  "crawl.confirm.recrawl.switch.message": "Diese Quelle wurde zuletzt mit {{indexedModel}} indexiert. Der Crawl indexiert mit {{configuredModel}}. Unveränderte Seiten können übersprungen werden.",
