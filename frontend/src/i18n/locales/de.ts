...
export const de: Record<string, string> = {
  ...
  "trustCenter.disclaimer.banner":
    "Rechtliche Vorlagen zur Transparenz. Kein Ersatz für anwaltliche Prüfung oder einen unterzeichneten kundenspezifischen AVV.",
  ...
  "trustCenter.subtitle":
    "Souveränität, DSGVO by design und prüfbare Verarbeitung — AVV/DPA, Unterauftragsverarbeiter, TOM und KI-Transparenz.",
