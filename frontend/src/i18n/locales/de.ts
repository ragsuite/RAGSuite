...
export const de: Record<string, string> = {
  ...
  "chatbot.widget.app.scrollToLatest.a11y": "Zu den neuesten Nachrichten scrollen",
  ...
  "chatbot.widget.options.showSpeech": "Sprache",
  "chatbot.widget.options.showSpeech.helper": "Mikrofon- und Lautsprechersteuerung für Spracheingabe und Vorlesen von Antworten anzeigen.",
  "chatbot.widget.options.showSpeechInput": "Spracheingabe",
  "chatbot.widget.options.showSpeechInput.helper": "Mikrofonsteuerung für Sprache-zu-Text im Chat-Composer anzeigen.",
  "chatbot.widget.options.showSpeechOutput": "Sprachausgabe",
  "chatbot.widget.options.showSpeechOutput.helper": "Lautsprechersteuerung zum Vorlesen von Antworten anzeigen.",
  ...
  "search.customisation.showSpeech.label": "Sprache",
  "search.customisation.showSpeech.helper": "Mikrofon- und Lautsprechersteuerung für Spracheingabe und Vorlesen von Antworten anzeigen.",
  "search.customisation.showSpeechInput.label": "Spracheingabe",
  "search.customisation.showSpeechInput.helper": "Mikrofonsteuerung für Sprache-zu-Text im Suchfeld anzeigen.",
  "search.customisation.showSpeechOutput.label": "Sprachausgabe",
  "search.customisation.showSpeechOutput.helper": "Lautsprechersteuerung zum Vorlesen von Suchantworten anzeigen.",
