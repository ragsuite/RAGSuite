...
export const de: Record<string, string> = {
  ...
  "crawl.jobs.detail.statsHelp.body":
    "Crawled bedeutet Seiten, die wir erfolgreich besucht haben. Beim erneuten Crawl bleiben unveränderte Seiten unter Crawled und werden nicht erneut gespeichert. Skipped gilt nur für gefilterte oder ungültige Links. Failed gilt für Seiten, die wir nicht laden konnten.",
  ...
  "integrations.credentials.manageApiKeys": "Konfiguration → API-Schlüssel öffnen",
