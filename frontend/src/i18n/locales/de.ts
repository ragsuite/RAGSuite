...
export const de: Record<string, string> = {
  ...
  "chatbot.widget.logo.enterpriseLocked": "Eigenes Logo hochladen ist in RAGSuite Enterprise verfügbar.",
  ...
  "chatbot.widget.options.showBackdrop": "Dunkles Overlay anzeigen",
  "chatbot.widget.options.showDateTime": "Datum & Uhrzeit anzeigen",
  "chatbot.widget.options.showLogo": "Logo anzeigen",
  "chatbot.widget.disclaimer.title": "Widget-Fußzeile",
  "chatbot.widget.disclaimer.subtitle": "KI-Hinweis und Markenlink unter dem Eingabefeld.",
  "chatbot.widget.disclaimer.show": "KI-Hinweis anzeigen",
  "chatbot.widget.disclaimer.text": "Hinweistext",
  "chatbot.widget.disclaimer.showLink": "Markenlink anzeigen",
  "chatbot.widget.disclaimer.showLink.helper": "Link neben dem Hinweis (z. B. ragsuite.de).",
  "chatbot.widget.disclaimer.linkLabel": "Link-Beschriftung",
  "chatbot.widget.disclaimer.linkUrl": "Link-URL",
  "chatbot.widget.disclaimer.enterpriseLocked":
    "Enterprise White-Label schaltet eigenen Hinweistext und Markenlink frei.",
