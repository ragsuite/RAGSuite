...
export const hi: Record<string, string> = {
  ...
  "crawl.confirm.recrawl.message": "यह स्रोत पहले से क्रॉल और अनुक्रमित है। अपरिवर्तित पृष्ठ छोड़ दिए जाएंगे। केवल नए या अपडेट किए गए पृष्ठ सहेजे और अनुक्रमित किए जाएंगे।",
