...
export const hi: Record<string, string> = {
  ...
  "crawl.jobs.detail.statsHelp.body":
    "Crawled का मतलब है वे पृष्ठ जिन्हें हमने सफलतापूर्वक देखा। पुनः क्रॉल पर अपरिवर्तित पृष्ठ Crawled में ही रहते हैं और दोबारा नहीं सहेजे जाते। Skipped केवल फ़िल्टर या अमान्य लिंक के लिए है। Failed उन पृष्ठों के लिए है जिन्हें हम लोड नहीं कर सके।",
