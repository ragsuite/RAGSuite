...
export const es: Record<string, string> = {
  ...
  "crawl.jobs.detail.statsHelp.body":
    "Crawled significa páginas que visitamos correctamente. En un nuevo rastreo, las páginas sin cambios permanecen en Crawled y no se vuelven a guardar. Skipped es solo para enlaces filtrados o no válidos. Failed es para páginas que no pudimos cargar.",
