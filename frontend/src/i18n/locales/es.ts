...
export const es: Record<string, string> = {
  ...
  "crawl.confirm.recrawl.message": "Esta fuente ya está rastreada e indexada. Las páginas sin cambios se omitirán. Solo se guardarán e indexarán las páginas nuevas o actualizadas.",
