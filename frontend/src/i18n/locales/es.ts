...
export const es: Record<string, string> = {
  ...
  "chatbot.widget.logo.enterpriseLocked": "La carga de un logo personalizado está disponible en RAGSuite Enterprise.",
  ...
  "chatbot.widget.options.showBackdrop": "Mostrar superposición oscura",
  ...
  "chatbot.widget.settings.bottomSpace": "Espacio inferior del widget: {{count}}px",
