...
export const es: Record<string, string> = {
  ...
  "chatbot.widget.options.showSpeech.helper": "Mostrar el micrófono y el altavoz para dictado y lectura en voz alta.",
  "chatbot.widget.options.showSpeechInput": "Entrada de voz",
  "chatbot.widget.options.showSpeechInput.helper": "Mostrar el micrófono para dictado en el compositor del chat.",
  "chatbot.widget.options.showSpeechOutput": "Salida de voz",
  "chatbot.widget.options.showSpeechOutput.helper": "Mostrar el altavoz para leer las respuestas en voz alta.",
  "chatbot.widget.settings.panelCornerRadius": "Radio de esquina del panel: {{count}}px",
