...
export const pt: Record<string, string> = {
  ...
  "chatbot.screen.subtitle": "Configure e gerencie a configuração, as definições e as integrações do seu chatbot",
  ...
  "chatbot.training.activeConfig.unavailable": "Nenhuma configuração ativa do chatbot.",
  ...
  "chatbot.training.overview.unavailable": "Nenhuma visão geral da configuração disponível.",
  ...
  "chatbot.widget.avatar.alt": "Imagem do chat",
  ...
  "chatbot.widget.avatar.subtitle": "Escolha uma imagem ou envie uma.",
  "chatbot.widget.avatar.title": "Imagem do chat",
  ...
  "chatbot.widget.colour.subtitle": "Escolha as cores do seu chat.",
  "chatbot.widget.colour.title": "Cores principais",
  "chatbot.widget.customisation.subtitle": "Mude a aparência do seu chat.",
  ...
  "chatbot.widget.logo.subtitle": "Adicione a imagem que aparece no chat.",
  ...
  "chatbot.widget.disclaimer.subtitle":
    "Nota curta abaixo da caixa de mensagem. Você pode adicionar um link do site.",
  ...
  "chatbot.widget.preview.a11y": "Prévia do chat",
  "chatbot.widget.preview.close": "Fechar",
  "chatbot.widget.preview.onSiteWidth": "No seu site: largura {{count}}",
  "chatbot.widget.preview.open": "Abrir",
  "chatbot.widget.preview.scaled": "Reduzido para caber",
  "chatbot.widget.preview.subtitleInteractive": "Veja como o chat vai ficar",
  "chatbot.widget.preview.subtitleScaled":
    "Reduzido aqui (largura {{count}})",
  "chatbot.widget.preview.title": "Prévia",
  ...
  "chatbot.widget.settings.customWidth": "Largura própria",
  ...
  "common.web": "Rede",
  "common.yes": "Sim",
  "compareModels.confirm.deleteConfig.message": "Remover {{provider}} / {{model}} da comparação?",
  "compareModels.confirm.deleteConfig.title": "Remover este modelo?",
  ...
  "compareModels.savedConfigs.deleteA11y": "Remover {{model}}",
  "compareModels.savedConfigs.excluded": "Desligado nesta comparação",
  "compareModels.savedConfigs.included": "Ligado nesta comparação",
  ...
  "compareModels.savedConfigs.manage": "Gerenciar modelos",
  "compareModels.savedConfigs.title": "Seus modelos",
  "compareModels.savedConfigs.toggleA11y": "Alternar {{model}} nesta comparação",
  ...
  "search.training.activeConfig.unavailable": "Nenhuma configuração ativa de pesquisa.",
  ...
  "search.training.overview.unavailable": "Nenhuma visão geral da configuração disponível.",
