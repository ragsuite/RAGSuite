...
export const pt: Record<string, string> = {
  ...
  "crawl.confirm.recrawl.message": "Esta fonte já foi rastreada e indexada. Páginas inalteradas serão ignoradas. Apenas páginas novas ou atualizadas serão salvas e indexadas.",
