...
export const pt: Record<string, string> = {
  ...
  "chatbot.widget.logo.defaultBrand": "Marca RAGSuite (padrão)",
  "chatbot.widget.logo.enterpriseLocked": "O upload de um logo personalizado está disponível no RAGSuite Enterprise.",
