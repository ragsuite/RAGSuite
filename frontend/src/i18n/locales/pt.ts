...
export const pt: Record<string, string> = {
  ...
  "crawl.jobs.detail.statsHelp.body":
    "Crawled significa páginas que visitamos com sucesso. Em um novo rastreamento, páginas inalteradas permanecem em Crawled e não são salvas novamente. Skipped é apenas para links filtrados ou inválidos. Failed é para páginas que não conseguimos carregar.",
