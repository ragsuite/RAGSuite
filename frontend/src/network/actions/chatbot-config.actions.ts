...
export async function handleSaveChatbotPrivacyNotice(
  body: ChatbotPrivacyNoticeUpdate,
  params: ChatbotApiQueryParams = {},
): Promise<unknown> {
  return post(withProjectQuery(API_CONFIG.CHATBOT_PRIVACY_NOTICE, params), body);
}
