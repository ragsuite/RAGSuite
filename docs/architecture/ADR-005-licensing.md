...
- License payload lists entitlement keys (opaque strings), e.g. `sso`, `organization`, `audit_full`, `compliance`, `compare_models`, `query_tracing`, `analytics`, `mobile_beta`, `voice`, `ai_voice_pilot`.
